...
class ChatListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: ListTile(
        leading: Image.network('https://images.unsplash.com/photo-1601288496920-b6154fe3626a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8dGVlbmFnZSUyMGdpcmx8ZW58MHx8MHx8&w=1000&q=80'),
